...
#  Usage A (one-liner)   : irm https://raw.githubusercontent.com/Tzu-YangLi/claude-statusline/main/scripts/install.ps1 | iex
#  Usage B (from a clone): powershell -NoProfile -ExecutionPolicy Bypass -File .\install.ps1
#  Compatible with Windows PowerShell 5.1
# =============================================================
$ErrorActionPreference = 'Stop'

$repoRawBase = 'https://raw.githubusercontent.com/Tzu-YangLi/claude-statusline/main/scripts'
