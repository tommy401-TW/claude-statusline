...
#  Usage A (one-liner)   : curl -fsSL https://raw.githubusercontent.com/Tzu-YangLi/claude-statusline/main/scripts/install.sh | bash
#  Usage B (from a clone): bash ./install.sh
#  Requires: python3
# =============================================================
set -euo pipefail

REPO_RAW_BASE="https://raw.githubusercontent.com/Tzu-YangLi/claude-statusline/main/scripts"
